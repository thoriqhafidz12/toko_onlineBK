                            ...
                            <div class="pd-desc">
                                ...
                                <?php if ($session->get('isLoggedIn')) : ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <?= form_input($diskon) ?>
                                        <div class="medium" style="background-color:yellow;" id="diskon_note"></div>
                                    </div>
                                    <div class="form-group">
        ...
        $("#diskon").on('change', function() {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    //
                    if (data['found'] == 0) {
                        $("#diskon_note").html('Kode Voucher tidak ditemukan');
                        $("#total_harga").val(total_harga);
                    } else {
                        ...
                        if (date_start <= date_now && date_now <= date_end) {
                            var disc_ammout = total_harga * data['disc'] / 100;
                            $("#diskon_note").html('Selamat, Diskon anda ' + data['disc'] + '% diterapkan sebesar Rp.' + disc_ammout);
                            $("#total_harga").val(total_harga - disc_ammout);
                        } else {
                            $("#diskon_note").html("Kode voucher tidak berlaku di tanggal sekarang");
                            $("#total_harga").val(total_harga);
                        }
                    }
                },
